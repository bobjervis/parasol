...
The syntax choices are probably closer to Java, given that the designers of that language did a good job with features like enum's as classes, variable argument lists, no header files, etc.
