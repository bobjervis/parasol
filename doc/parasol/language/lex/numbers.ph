...
A sequence of one or more decimal digits beginning with a non-zero digits is a <i>decimal integer</i>.
...
A sequence of two or more decimal digits with a period (decimal point) contained between two of the digits followed 
by an optional exponent and/or an optional type specifier is a <i>floating point number</i>.
An exponent is the letter <b>e</b> or <b>E</b> followed by an optional plus (+) or minus (-) sign and one or more decimal digits.
